...
function start(app, dataStores) {
    ...
    var notificationLogic = notificationRules(app, locationStore);
    var schedule = scheduler(meetingStore, notificationLogic);
    ...
    function handleMeetingRequest(meeting) {
        ...
        function setDefaultLocation(meeting) {
            ...
            // Temporary default location, QUT Gardens Point Campus.
            meeting.latitude = -27.477491;
            meeting.longitude = 153.028395;
        }
